...
/**
 * Describes an abstract active behaviour of an agent. It is scheduled and executed periodically, according to
 * the specified period.
 * 
 * @author Marcel Patzlaff
 */
public abstract class AbstractActiveBehaviour extends AbstractPeriodicRunnable implements IAgentElement, ILifecycleAware {
