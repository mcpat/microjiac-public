...
# Java Options
JAVA_OPTIONS='-Xrunhprof:cpu=times,depth=6,thread=y'
# echo 'Java Options: '$JAVA_OPTIONS

# Main Class
MAIN_CLASS='de.jiac.micro.internal.ApplicationLauncher'

# Main Class Parameters
MAIN_CLASS_PARAMETERS='de.jiac.micro.test.jms.floodtest'
