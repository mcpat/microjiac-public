...
public class NodeConfiguration extends AbstractConfiguration {
    ...
    public NodeConfiguration(String className, CharSequence source, String[] fullQualifiedAgentConfigurationNames) {
        super(className, source);
        this.fullQualifiedAgentConfigurationNames= fullQualifiedAgentConfigurationNames;
    }
}
